class SaaslogicMigration < ActiveRecord::Migration
  def self.up
    create_table :subscriptions, :force => true do |t|
      ...
      # add resource limitations, e.g.
      # t.integer :max_users
      # t.integer :max_memory
      # t.integer :telephone_support
      # NOTE: is these are instance copies of app-speicific limted defined in subscription_plans table
